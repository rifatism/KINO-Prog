document.addEventListener('DOMContentLoaded', () => {
  ...
  const places = [
    ...
    {title:'Камчатка',coords:[59.9550,30.3376],address:'ул. Блохина, 15',text:'Бывшая котельная, где Цой работал кочегаром.',photo:'https://dynamic-media-cdn.tripadvisor.com/media/photo-o/04/01/40/04/caption.jpg?w=900&h=500&s=1'},
